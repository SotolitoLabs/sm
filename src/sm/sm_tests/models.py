...
class MentalTestField(models.Model):
    ...
    name = models.CharField(max_length=255)
    description = models.TextField(blank=True, null=True)
    field_type = models.ForeignKey(MentalTestFieldType, related_name='fieldtypes', on_delete=models.DO_NOTHING)
...
class MentalTestResult(models.Model):
    ...
    test_field = models.ForeignKey(MentalTestField, related_name='mentaltestfieldtypes', on_delete=models.DO_NOTHING)
